...
## Ohjelman käynnistys
Voit käynnistää sovelluksen lataamalla viimeisimmän releasen [jar tiedoston](https://github.com/sanikemppainen/ot-harjoitustyo/releases/tag/final1.2) joka sitten tulee purkaa.
