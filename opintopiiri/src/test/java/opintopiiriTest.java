...
/**
 *Test Class for opintopiiri application
 * @author ksani
 */
public class opintopiiriTest {
    ...
    /*@Test
    public void lisaakauttajannimi() throws SQLException{
        userdao.addUser(new opintopiiri.domain.User("testinimi", "testisalasana",0,0,0,0));
        String vastaus= userdao.toString();
        assertEquals("Nimi: testinimi, Salasana: testisalasana", vastaus);
    ...
    public void setIndexToZero(){
        ...
        assertEquals("I: 0, Points: 0.0, IA: -1, q1no: 0, q2no: 0", functions.toString());
    ...
    public void checkIfAddsNoTimesPlayed1(){
        ...
        //assertEquals(3, functions.toString());
    ...
    public void checkIfAddsNoTimesPlayed2(){
        ...
        assertEquals("I: 0, Points: 0.0, IA: -1, q1no: 0, q2no: 1", functions.toString());
